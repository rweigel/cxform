static char const Ident[] = "@(#) $XX: cxform-auto.c   c:1.21 pl:1.32 $";
/*
** This file is automatically generated.  *** DO NOT EDIT BY HAND! ***
**
** Generated by the script `gen_cxform_auto.pl', version 1.32,
** from input `cxform-manual.c' version 1.21.
**
...
*/
enum systems { UNKNOWN, J2000, GEI, GEO, MAG, GSE, GSM, SM, HEE, HAE };
...
int cxform(const char *from, const char *to, double t, Vec v_in, Vec v_out)
{
  ...
  if ((from_n = system_number(from)) == UNKNOWN) {
    ...
    strcat(cxform_err_buf, " must be one of: J2000 GEI GEO MAG GSE GSM SM HEE HAE");
    return 1;
  }
